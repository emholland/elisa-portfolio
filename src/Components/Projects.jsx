...
It's still a work in progress, but you can check out the current version here:`,
    ...
    },
    {
      ...
      media: {
        ...
        link: "DS Final_ Startup Failure Predictor.pdf",
      },
...
- Bridged the gap between machine learning outputs and strategic business insights in a final report and live presentation.`,
    ...
    },
    {
      ...
      description: `**A real-time multiplayer strategy game implemented with React Native and WebSocket**
...
The final product simulates the Mafia party game in a digital environment, providing an engaging, stateful multiplayer experience with minimal latency.`,
    ...
    },
    {
      ...
      description: `**A full-stack restaurant review platform with user authentication and dynamic content**
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      {projects.map((proj, index) => {
        ...
        return (
          ...
          >
            <h3 className="text-lg font-semibold text-purple-800">{proj.title}</h3>
            <p className="text-sm text-purple-600 italic mb-2">{proj.date}</p>
